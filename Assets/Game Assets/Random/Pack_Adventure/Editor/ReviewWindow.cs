...
namespace AssetReview.Editor
{
    ...
    {
        const string assetName = "Explorer Couple";
        ...
        void OnEnable()
        {
            previewTex = AssetDatabase.LoadAssetAtPath<Texture2D>(
                "Assets/Pack_Adventure/Editor/preview.png"
            );
        }
        ...
        void OnGUI()
        {
            ...
            {
                Application.OpenURL("https://assetstore.unity.com/packages/3d/characters/explorer-couple-275490#reviews");
                Close();
            }
            GUILayout.FlexibleSpace();
        ...
        {
            string editorPath = "Assets/Pack_Adventure/Editor";
